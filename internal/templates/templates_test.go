...
func TestRenderWithVariables(t *testing.T) {
	...
	tests := []struct {
		...
		{"makefile.tmpl", []string{"BINARY_NAME", "go build", "main.version", "release-local", "serve: all"}},
		...
		{"goreleaser_yml.tmpl", []string{"project_name: myapp", "main.version", "ghcr.io/example/myapp", "myapp-linux", "myapp-macos", "myapp-windows", "brews:", "dockers_v2:"}},
